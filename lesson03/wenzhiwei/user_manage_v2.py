# -*- coding: utf-8 -*-
# @Time    : 2019-05-27 10:33
# @Author  : Joe
# @Site    : 
# @File    : user_manage_v2.py
# @Software: PyCharm
# @function: xxxxx
...
add wenzhiwei 18 13800138000 wennjoe@163.com
        ...
        while True:
            ...
            if user_list[0] == 'add':
                if user_list[1] not in user_dict:
                    ...
                    user_dict[user_list[1]]['name'] = user_list[1]
                    user_dict[user_list[1]]['age'] = user_list[2]
                    user_dict[user_list[1]]['telephone'] = user_list[3]
                    user_dict[user_list[1]]['email'] = user_list[4]
                    record_data_to_file()
                else:
