...
while INIT_FAIL_CNT < MAX_FAIL_CNT:
    try:
        username = input("\n\033[1;33;44m Please input your username \033[0m\n:")
        password = input("\n\033[1;33;41m Please input your password \033[0m\n:")
        ClearScreen()
            ...
            # 分页实现
                ...
                try:
                    if len(info_list) != 2:
                        ...
                        for i in impData:
                            if len(i) != len(FIELDS):
                                print("\033[31m The format of csvfile is wrong! Please check format of file!\33[0m")
                                break
                                # 重复数据校验
                            else:
                                dataList.append(i)
                        ...
                        if len(RESULT) != lengthRST:
                            print('\033[32m Import {} succeed ! \033[0m'.format(info_list[1]))
